...
import { PeppolBase64 } from './peppol-base-64-schema.ts';

describe('PeppolBase64', () => {
  it.for([
    ...
    expect(Schema.is(PeppolBase64)(val)).toBe(true);
  });
  ...
  it.for([
    ...
    expect(Schema.is(PeppolBase64)(val)).toBe(false);
  });
});
