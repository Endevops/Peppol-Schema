...
import { validateCenEn16931Br43 } from './cen-en16931-br-43.ts';
...
describe('CEN-EN16931-BR-43', () => {
  it.effect(
    ...
    Effect.fn(function* () {
      ...
      yield* validateCenEn16931Br43(document);
    })
  );
  ...
  it.effect(
    ...
    Effect.fn(function* () {
      ...
      const result = yield* validateCenEn16931Br43(document).pipe(Effect.result);
