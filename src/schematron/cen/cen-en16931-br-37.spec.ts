...
import { validateCenEn16931Br37 } from './cen-en16931-br-37.ts';
...
describe('CEN-EN16931-BR-37', () => {
  it.effect(
    ...
    Effect.fn(function* () {
      ...
      yield* validateCenEn16931Br37(document);
    })
  );
  ...
  it.effect(
    ...
    Effect.fn(function* () {
      ...
      const result = yield* validateCenEn16931Br37(document).pipe(Effect.result);
