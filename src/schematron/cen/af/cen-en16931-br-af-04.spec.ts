...
import { validateCenEn16931BrAf04 } from './cen-en16931-br-af-04.ts';
...
describe('CEN-EN16931-BR-AF-04', () => {
  it.effect(
    ...
    Effect.fn(function* () {
      ...
      yield* validateCenEn16931BrAf04(document);
    })
  );
  ...
  it.effect(
    ...
    Effect.fn(function* () {
      ...
      const result = yield* validateCenEn16931BrAf04(document).pipe(Effect.result);
