...
import { validateCenEn16931BrAf07 } from './cen-en16931-br-af-07.ts';
...
describe('CEN-EN16931-BR-AF-07', () => {
  it.effect(
    ...
    Effect.fn(function* () {
      ...
      yield* validateCenEn16931BrAf07(document);
    })
  );
  ...
  it.effect(
    ...
    Effect.fn(function* () {
      ...
      const result = yield* validateCenEn16931BrAf07(document).pipe(Effect.result);
