...
import { validateCenEn16931BrAf05 } from './cen-en16931-br-af-05.ts';
...
describe('CEN-EN16931-BR-AF-05', () => {
  it.effect(
    ...
    Effect.fn(function* () {
      ...
      yield* validateCenEn16931BrAf05(document);
    })
  );
  ...
  it.effect(
    ...
    Effect.fn(function* () {
      ...
      const result = yield* validateCenEn16931BrAf05(document).pipe(Effect.result);
