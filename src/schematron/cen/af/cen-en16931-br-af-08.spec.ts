...
import { validateCenEn16931BrAf08 } from './cen-en16931-br-af-08.ts';
...
describe('CEN-EN16931-BR-AF-08', () => {
  it.effect(
    ...
    Effect.fn(function* () {
      ...
      yield* validateCenEn16931BrAf08(document);
    })
  );
  ...
  it.effect(
    ...
    Effect.fn(function* () {
      ...
      const result = yield* validateCenEn16931BrAf08(document).pipe(Effect.result);
