...
import { validateCenEn16931BrAf03 } from './cen-en16931-br-af-03.ts';
...
describe('CEN-EN16931-BR-AF-03', () => {
  it.effect(
    ...
    Effect.fn(function* () {
      ...
      yield* validateCenEn16931BrAf03(document);
    })
  );
  ...
  it.effect(
    ...
    Effect.fn(function* () {
      ...
      const result = yield* validateCenEn16931BrAf03(document).pipe(Effect.result);
