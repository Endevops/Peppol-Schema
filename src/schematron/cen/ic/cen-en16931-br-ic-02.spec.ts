...
import { validateCenEn16931BrIc02 } from './cen-en16931-br-ic-02';

describe('CEN-EN16931-BR-IC-02', () => {
  it('passes on the base example', async () => {
    const document = await decodeBaseExample();
    expect(validateCenEn16931BrIc02(document).passed).toEqual(true);
  });
  ...
  it('fails when the rule is violated', async () => {
    ...
    expect(validateCenEn16931BrIc02(document).passed).toEqual(false);
  });
});
