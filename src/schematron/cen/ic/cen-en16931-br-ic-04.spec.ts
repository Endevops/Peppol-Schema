...
import { validateCenEn16931BrIc04 } from './cen-en16931-br-ic-04.ts';
...
describe('CEN-EN16931-BR-IC-04', () => {
  it.effect(
    ...
    Effect.fn(function* () {
      ...
      yield* validateCenEn16931BrIc04(document);
    })
  );
  ...
  it.effect(
    ...
    Effect.fn(function* () {
      ...
      const result = yield* validateCenEn16931BrIc04(document).pipe(Effect.result);
