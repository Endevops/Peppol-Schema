...
import { validateCenEn16931BrIc07 } from './cen-en16931-br-ic-07.ts';
...
describe('CEN-EN16931-BR-IC-07', () => {
  it.effect(
    ...
    Effect.fn(function* () {
      ...
      yield* validateCenEn16931BrIc07(document);
    })
  );
  ...
  it.effect(
    ...
    Effect.fn(function* () {
      ...
      const result = yield* validateCenEn16931BrIc07(document).pipe(Effect.result);
