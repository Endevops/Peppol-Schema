...
import { validateCenEn16931BrIc08 } from './cen-en16931-br-ic-08.ts';
...
describe('CEN-EN16931-BR-IC-08', () => {
  it.effect(
    ...
    Effect.fn(function* () {
      ...
      yield* validateCenEn16931BrIc08(document);
    })
  );
  ...
  it.effect(
    ...
    Effect.fn(function* () {
      ...
      const result = yield* validateCenEn16931BrIc08(document).pipe(Effect.result);
