...
import { validateCenEn16931BrIc09 } from './cen-en16931-br-ic-09.ts';
...
describe('CEN-EN16931-BR-IC-09', () => {
  it.effect(
    ...
    Effect.fn(function* () {
      ...
      yield* validateCenEn16931BrIc09(document);
    })
  );
  ...
  it.effect(
    ...
    Effect.fn(function* () {
      ...
      const result = yield* validateCenEn16931BrIc09(document).pipe(Effect.result);
