...
import { validateCenEn16931BrIc03 } from './cen-en16931-br-ic-03.ts';
...
describe('CEN-EN16931-BR-IC-03', () => {
  it.effect(
    ...
    Effect.fn(function* () {
      ...
      yield* validateCenEn16931BrIc03(document);
    })
  );
  ...
  it.effect(
    ...
    Effect.fn(function* () {
      ...
      const result = yield* validateCenEn16931BrIc03(document).pipe(Effect.result);
