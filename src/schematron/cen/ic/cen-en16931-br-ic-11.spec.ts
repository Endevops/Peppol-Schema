...
import { validateCenEn16931BrIc11 } from './cen-en16931-br-ic-11.ts';
...
describe('CEN-EN16931-BR-IC-11', () => {
  it.effect(
    ...
    Effect.fn(function* () {
      ...
      yield* validateCenEn16931BrIc11(document);
    })
  );
  ...
  it.effect(
    ...
    Effect.fn(function* () {
      ...
      const result = yield* validateCenEn16931BrIc11(document).pipe(Effect.result);
