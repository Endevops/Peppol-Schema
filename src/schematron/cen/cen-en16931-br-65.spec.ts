...
import { validateCenEn16931Br65 } from './cen-en16931-br-65.ts';
...
describe('CEN-EN16931-BR-65', () => {
  it.effect(
    ...
    Effect.fn(function* () {
      ...
      yield* validateCenEn16931Br65(document);
    })
  );
  ...
  it.effect(
    ...
    Effect.fn(function* () {
      ...
      const result = yield* validateCenEn16931Br65(document).pipe(Effect.result);
