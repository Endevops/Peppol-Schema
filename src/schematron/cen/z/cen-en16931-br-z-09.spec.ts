...
import { validateCenEn16931BrZ09 } from './cen-en16931-br-z-09.ts';
...
describe('CEN-EN16931-BR-Z-09', () => {
  it.effect(
    ...
    Effect.fn(function* () {
      ...
      yield* validateCenEn16931BrZ09(document);
    })
  );
  ...
  it.effect(
    ...
    Effect.fn(function* () {
      ...
      const result = yield* validateCenEn16931BrZ09(document).pipe(Effect.result);
