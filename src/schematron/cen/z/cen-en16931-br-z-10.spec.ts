...
import { validateCenEn16931BrZ10 } from './cen-en16931-br-z-10.ts';
...
describe('CEN-EN16931-BR-Z-10', () => {
  it.effect(
    ...
    Effect.fn(function* () {
      ...
      yield* validateCenEn16931BrZ10(document);
    })
  );
  ...
  it.effect(
    ...
    Effect.fn(function* () {
      ...
      const result = yield* validateCenEn16931BrZ10(document).pipe(Effect.result);
