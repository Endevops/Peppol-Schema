...
import { validateCenEn16931BrZ05 } from './cen-en16931-br-z-05.ts';
...
describe('CEN-EN16931-BR-Z-05', () => {
  it.effect(
    ...
    Effect.fn(function* () {
      ...
      yield* validateCenEn16931BrZ05(document);
    })
  );
  ...
  it.effect(
    ...
    Effect.fn(function* () {
      ...
      const result = yield* validateCenEn16931BrZ05(document).pipe(Effect.result);
