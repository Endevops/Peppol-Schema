...
import { validateCenEn16931BrZ06 } from './cen-en16931-br-z-06.ts';
...
describe('CEN-EN16931-BR-Z-06', () => {
  it.effect(
    ...
    Effect.fn(function* () {
      ...
      yield* validateCenEn16931BrZ06(document);
    })
  );
  ...
  it.effect(
    ...
    Effect.fn(function* () {
      ...
      const result = yield* validateCenEn16931BrZ06(document).pipe(Effect.result);
