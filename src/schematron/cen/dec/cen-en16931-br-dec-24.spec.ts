...
import { validateCenEn16931BrDec24 } from './cen-en16931-br-dec-24.ts';
...
describe('CEN-EN16931-BR-DEC-24', () => {
  it.effect(
    ...
    Effect.fn(function* () {
      ...
      yield* validateCenEn16931BrDec24(document);
    })
  );
  ...
  it.effect(
    ...
    Effect.fn(function* () {
      ...
      const result = yield* validateCenEn16931BrDec24(document).pipe(Effect.result);
