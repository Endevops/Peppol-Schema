...
import { validateCenEn16931BrDec01 } from './cen-en16931-br-dec-01.ts';
...
describe('CEN-EN16931-BR-DEC-01', () => {
  it.effect(
    ...
    Effect.fn(function* () {
      ...
      yield* validateCenEn16931BrDec01(document);
    })
  );
  ...
  it.effect(
    ...
    Effect.fn(function* () {
      ...
      const result = yield* validateCenEn16931BrDec01(document).pipe(Effect.result);
