...
import { validateCenEn16931BrDec05 } from './cen-en16931-br-dec-05.ts';
...
describe('CEN-EN16931-BR-DEC-05', () => {
  it.effect(
    ...
    Effect.fn(function* () {
      ...
      yield* validateCenEn16931BrDec05(document);
    })
  );
  ...
  it.effect(
    ...
    Effect.fn(function* () {
      ...
      const result = yield* validateCenEn16931BrDec05(document).pipe(Effect.result);
