...
import { validateCenEn16931BrDec12 } from './cen-en16931-br-dec-12.ts';
...
describe('CEN-EN16931-BR-DEC-12', () => {
  it.effect(
    ...
    Effect.fn(function* () {
      ...
      yield* validateCenEn16931BrDec12(document);
    })
  );
  ...
  it.effect(
    ...
    Effect.fn(function* () {
      ...
      const result = yield* validateCenEn16931BrDec12(document).pipe(Effect.result);
