...
import { validateCenEn16931Br63 } from './cen-en16931-br-63';

describe('CEN-EN16931-BR-63', () => {
  it('passes on the base example', async () => {
    const document = await decodeBaseExample();
    expect(validateCenEn16931Br63(document).passed).toEqual(true);
  });
  ...
  it('fails when the rule is violated', async () => {
    ...
    expect(validateCenEn16931Br63(document).passed).toEqual(false);
  });
});
