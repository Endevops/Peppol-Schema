...
import { validateCenEn16931Br32 } from './cen-en16931-br-32.ts';
...
describe('CEN-EN16931-BR-32', () => {
  it.effect(
    ...
    Effect.fn(function* () {
      ...
      yield* validateCenEn16931Br32(document);
    })
  );
  ...
  it.effect(
    ...
    Effect.fn(function* () {
      ...
      const result = yield* validateCenEn16931Br32(document).pipe(Effect.result);
