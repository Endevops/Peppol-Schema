...
import { validateCenEn16931BrCo23 } from './cen-en16931-br-co-23.ts';
...
describe('CEN-EN16931-BR-CO-23', () => {
  it.effect(
    ...
    Effect.fn(function* () {
      ...
      yield* validateCenEn16931BrCo23(document);
    })
  );
  ...
  it.effect(
    ...
    Effect.fn(function* () {
      ...
      const result = yield* validateCenEn16931BrCo23(document).pipe(Effect.result);
