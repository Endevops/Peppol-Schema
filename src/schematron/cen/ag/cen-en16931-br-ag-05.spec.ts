...
import { validateCenEn16931BrAg05 } from './cen-en16931-br-ag-05';

describe('CEN-EN16931-BR-AG-05', () => {
  it('passes on the base example', async () => {
    const document = await decodeBaseExample();
    expect(validateCenEn16931BrAg05(document).passed).toEqual(true);
  });
  ...
  it('fails when the rule is violated', async () => {
    ...
    expect(validateCenEn16931BrAg05(document).passed).toEqual(false);
  });
});
