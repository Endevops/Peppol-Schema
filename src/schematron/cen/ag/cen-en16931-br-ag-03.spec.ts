...
import { validateCenEn16931BrAg03 } from './cen-en16931-br-ag-03.ts';
...
describe('CEN-EN16931-BR-AG-03', () => {
  it.effect(
    ...
    Effect.fn(function* () {
      ...
      yield* validateCenEn16931BrAg03(document);
    })
  );
  ...
  it.effect(
    ...
    Effect.fn(function* () {
      ...
      const result = yield* validateCenEn16931BrAg03(document).pipe(Effect.result);
