...
import { validateCenEn16931BrAg04 } from './cen-en16931-br-ag-04.ts';
...
describe('CEN-EN16931-BR-AG-04', () => {
  it.effect(
    ...
    Effect.fn(function* () {
      ...
      yield* validateCenEn16931BrAg04(document);
    })
  );
  ...
  it.effect(
    ...
    Effect.fn(function* () {
      ...
      const result = yield* validateCenEn16931BrAg04(document).pipe(Effect.result);
