...
import { validateCenEn16931BrAg06 } from './cen-en16931-br-ag-06.ts';
...
describe('CEN-EN16931-BR-AG-06', () => {
  it.effect(
    ...
    Effect.fn(function* () {
      ...
      yield* validateCenEn16931BrAg06(document);
    })
  );
  ...
  it.effect(
    ...
    Effect.fn(function* () {
      ...
      const result = yield* validateCenEn16931BrAg06(document).pipe(Effect.result);
