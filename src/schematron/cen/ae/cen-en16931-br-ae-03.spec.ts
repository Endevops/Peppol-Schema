...
import { validateCenEn16931BrAe03 } from './cen-en16931-br-ae-03.ts';
...
describe('CEN-EN16931-BR-AE-03', () => {
  it.effect(
    ...
    Effect.fn(function* () {
      ...
      yield* validateCenEn16931BrAe03(document);
    })
  );
  ...
  it.effect(
    ...
    Effect.fn(function* () {
      ...
      const result = yield* validateCenEn16931BrAe03(document).pipe(Effect.result);
