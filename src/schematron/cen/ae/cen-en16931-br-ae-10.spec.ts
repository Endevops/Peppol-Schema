...
import { validateCenEn16931BrAe10 } from './cen-en16931-br-ae-10';

describe('CEN-EN16931-BR-AE-10', () => {
  it('passes on the base example', async () => {
    const document = await decodeBaseExample();
    expect(validateCenEn16931BrAe10(document).passed).toEqual(true);
  });
  ...
  it('fails when the rule is violated', async () => {
    ...
    expect(validateCenEn16931BrAe10(document).passed).toEqual(false);
  });
});
