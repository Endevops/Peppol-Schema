...
import { validateCenEn16931Br42 } from './cen-en16931-br-42';

describe('CEN-EN16931-BR-42', () => {
  it('passes on the base example', async () => {
    const document = await decodeBaseExample();
    expect(validateCenEn16931Br42(document).passed).toEqual(true);
  });
  ...
  it('fails when the rule is violated', async () => {
    ...
    expect(validateCenEn16931Br42(document).passed).toEqual(false);
  });
});
