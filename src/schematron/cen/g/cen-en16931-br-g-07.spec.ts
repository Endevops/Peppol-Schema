...
import { validateCenEn16931BrG07 } from './cen-en16931-br-g-07.ts';
...
describe('CEN-EN16931-BR-G-07', () => {
  it.effect(
    ...
    Effect.fn(function* () {
      ...
      yield* validateCenEn16931BrG07(document);
    })
  );
  ...
  it.effect(
    ...
    Effect.fn(function* () {
      ...
      const result = yield* validateCenEn16931BrG07(document).pipe(Effect.result);
