...
import { validateCenEn16931BrE03 } from './cen-en16931-br-e-03.ts';
...
describe('CEN-EN16931-BR-E-03', () => {
  it.effect(
    ...
    Effect.fn(function* () {
      ...
      yield* validateCenEn16931BrE03(document);
    })
  );
  ...
  it.effect(
    ...
    Effect.fn(function* () {
      ...
      const result = yield* validateCenEn16931BrE03(document).pipe(Effect.result);
