...
import { validateCenEn16931BrO05 } from './cen-en16931-br-o-05.ts';
...
describe('CEN-EN16931-BR-O-05', () => {
  it.effect(
    ...
    Effect.fn(function* () {
      ...
      yield* validateCenEn16931BrO05(document);
    })
  );
  ...
  it.effect(
    ...
    Effect.fn(function* () {
      ...
      const result = yield* validateCenEn16931BrO05(document).pipe(Effect.result);
