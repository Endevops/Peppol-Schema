...
import { validateCenEn16931BrO11 } from './cen-en16931-br-o-11.ts';
...
describe('CEN-EN16931-BR-O-11', () => {
  it.effect(
    ...
    Effect.fn(function* () {
      ...
      yield* validateCenEn16931BrO11(document);
    })
  );
  ...
  it.effect(
    ...
    Effect.fn(function* () {
      ...
      const result = yield* validateCenEn16931BrO11(document).pipe(Effect.result);
