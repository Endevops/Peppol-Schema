...
import { validateCenEn16931BrO02 } from './cen-en16931-br-o-02.ts';
...
describe('CEN-EN16931-BR-O-02', () => {
  it.effect(
    ...
    Effect.fn(function* () {
      ...
      yield* validateCenEn16931BrO02(document);
    })
  );
  ...
  it.effect(
    ...
    Effect.fn(function* () {
      ...
      const result = yield* validateCenEn16931BrO02(document).pipe(Effect.result);
