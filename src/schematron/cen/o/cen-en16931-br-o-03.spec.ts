...
import { validateCenEn16931BrO03 } from './cen-en16931-br-o-03.ts';
...
describe('CEN-EN16931-BR-O-03', () => {
  it.effect(
    ...
    Effect.fn(function* () {
      ...
      yield* validateCenEn16931BrO03(document);
    })
  );
  ...
  it.effect(
    ...
    Effect.fn(function* () {
      ...
      const result = yield* validateCenEn16931BrO03(document).pipe(Effect.result);
