...
import { validateCenEn16931BrO09 } from './cen-en16931-br-o-09.ts';
...
describe('CEN-EN16931-BR-O-09', () => {
  it.effect(
    ...
    Effect.fn(function* () {
      ...
      yield* validateCenEn16931BrO09(document);
    })
  );
  ...
  it.effect(
    ...
    Effect.fn(function* () {
      ...
      const result = yield* validateCenEn16931BrO09(document).pipe(Effect.result);
