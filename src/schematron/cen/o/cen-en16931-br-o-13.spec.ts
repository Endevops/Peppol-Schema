...
import { validateCenEn16931BrO13 } from './cen-en16931-br-o-13.ts';
...
describe('CEN-EN16931-BR-O-13', () => {
  it.effect(
    ...
    Effect.fn(function* () {
      ...
      yield* validateCenEn16931BrO13(document);
    })
  );
  ...
  it.effect(
    ...
    Effect.fn(function* () {
      ...
      const result = yield* validateCenEn16931BrO13(document).pipe(Effect.result);
