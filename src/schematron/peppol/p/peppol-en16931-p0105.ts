...
function evaluatePeppolEn16931P0105(document: PeppolDocument): boolean {
...
export const validatePeppolEn16931P0105 = schematronRule(rule, evaluatePeppolEn16931P0105);
