...
export const icdCodes = {
   ...
   */
  '3': 'Codification Numerique des Etablissments Financiers En Belgique',
  /**
   ...
   */
  '10': 'Organizational Identifiers for Structured Names under ISO 9541 Part 2',
  /**
   ...
   */
  '11': 'International Code Designator for the Identification of OSI-based, Amateur Radio Organizations, Network Objects and Application Services.',
  /**
   ...
   * GERMANY.
   */
  '13': 'VSA FTP CODE (FTP = File Transfer Protocol)',
  /**
   ...
   */
  '14': "NIST/OSI Implememts' Workshop",
  /**
   ...
   */
  '19': 'Air Transport Industry Services Communications Network',
  /**
   ...
   */
  '21': 'SOCIETY FOR WORLDWIDE INTERBANK FINANCIAL, TELECOMMUNICATION S.W.I.F.T.',
  /**
   ...
   */
  '22': 'OSF Distributed Computing Object Identification',
  /**
   ...
   */
  '23': 'Nordic University and Research Network: NORDUnet',
  /**
   ...
   */
  '24': 'Digital Equipment Corporation: DEC',
  /**
   ...
   */
  '26': 'NATO ISO 6523 ICDE coding scheme',
  /**
   ...
   */
  '31': 'EDI Partner Identification Code',
  /**
   ...
   */
  '34': 'Reuter Open Address Standard',
  /**
   ...
   */
  '36': 'TeleTrust Object Identifiers',
  /**
   ...
   */
  '38': 'The Australian GOSIP Network',
  /**
   ...
   */
  '41': 'Citicorp Global Information Network',
  /**
   ...
   */
  '42': 'DBP Telekom Object Identifiers',
  /**
   ...
   */
  '44': 'Thai Industrial Standards Institute (TISI)',
  /**
   ...
   * UK.
   */
  '45': 'ICI Company Identification System',
  /**
   ...
   */
  '52': 'Society of Motion Picture and Television Engineers (SMPTE)',
  /**
   * @description Issuing agency: Migros-Genossenschafts-Bund, Switzerland.
   */
  '53': 'Migros_Network M_NETOPZ',
  /**
   ...
   */
  '56': 'Nokia Object Identifiers (NOI)',
  /**
   ...
   */
  '64': 'UTC: Uniforme Transport Code',
  /**
   ...
   */
  '69': 'SITA Object Identifier Tree',
  /**
   ...
   * AG, GERMANY.
   */
  '70': 'DaimlerChrysler Corporate Network',
  /**
   * @description Notes on Use of Code: The ICD code will also form the Initial Domain Part of the OSI network addressing and naming tree as specified in addendum
   ...
   */
  '75': 'Alcanet/Alcatel-Alsthom Corporate Network',
  /**
   ...
   */
  '76': 'Sistema Italiano di Identificazione di ogetti gestito da UNINFO',
  /**
   * @description Notes on Use of Code: The ICD code forms the initial part of the OSI network Addressing and naming tree depicted in Addendum 2 of ISO 8348.
   * Issuing agency: UNINFO, ITALY.
   */
  '77': 'Sistema Italiano di Indirizzamento di Reti OSI Gestito da UNINFO',
  /**
   ...
   */
  '78': 'Mitel terminal or switching equipment',
  /**
   ...
   */
  '80': 'UK National Health Service Scheme, (EDIRA compliant)',
  /**
   * @description Issuing agency: Federal Office for Communications, Switzerland.
   */
  '81': 'International NSAP',
  /**
   ...
   */
  '82': "Norwegian Telecommunications Authority's, NTA'S, EDI, identifier scheme (EDIRA compliant)",
  /**
   * @description Notes on Use of Code: The ICD code will also form part of the Initial Domain Part of the OSI network addressing as specified in Addendum 2 to ISO
   * 8348. Issuing agency: ATM Ltd, ENGLAND.
   */
  '83': 'Advanced Telecommunications Modules Limited, Corporate Network',
  /**
   ...
   * Greece.
   */
  '84': 'Athens Chamber of Commerce & Industry Scheme (EDIRA compliant)',
  /**
   ...
   */
  '85': 'Swiss Chambers of Commerce Scheme (EDIRA) compliant',
  /**
   ...
   */
  '86': 'United States Council for International Business (USCIB) Scheme, (EDIRA compliant)',
  /**
   * @description Issuing agency: National Federartion of Chambers of Commerce & Industry of, Belgium, Belgium.
   */
  '87': 'National Federation of Chambers of Commerce & Industry of Belgium, Scheme (EDIRA compliant)',
  /**
   ...
   */
  '89': 'The Association of British Chambers of Commerce Ltd. Scheme, (EDIRA compliant)',
  /**
   * @description Issuing agency: Internet Assigned Numbers Authority, USA.
   */
  '90': 'Internet IP addressing - ISO 6523 ICD encoding',
  /**
   * @description Issuing agency: Cisco Systems, USA.
   */
  '91': 'Cisco Sysytems / OSI Network',
  /**
   * @description Issuing agency: Revenue Canada, CANADA.
   */
  '93': 'Revenue Canada Business Number Registration (EDIRA compliant)',
  /**
   * @description Issuing agency: Deutscher Industrie -und Handelstag (DIHT), Germany.
   */
  '94': 'DEUTSCHER INDUSTRIE- UND HANDELSTAG (DIHT) Scheme (EDIRA compliant)',
  /**
   * @description Issuing agency: Hewlett - Packard Company, USA.
   */
  '95': 'Hewlett - Packard Company Internal AM Network',
  /**
   ...
   */
  '98': 'CHAMBER OF COMMERCE TEL AVIV-JAFFA Scheme (EDIRA compliant)',
  /**
   * @description Issuing agency: Siemens AG, Germany.
   */
  '99': 'Siemens Supervisory Systems Network',
  /**
   ...
   */
  '101': 'South African Code Allocation',
  /**
   ...
   */
  '104': 'BT - ICD Coding System',
  /**
   * @description Issuing agency: Portuguese Chamber of Commerce and Industry, Portugal.
   */
  '105': 'Portuguese Chamber of Commerce and Industry Scheme (EDIRA compliant)',
  /**
   ...
   */
  '107': 'Association of Swedish Chambers of Commerce and Industry Scheme (EDIRA compliant)',
  /**
   * @description Issuing agency: Australian Chambers of Commerce and Industry, Australia.
   */
  '108': 'Australian Chambers of Commerce and Industry Scheme (EDIRA compliant)',
  /**
   * @description Issuing agency: BellSouth Corporation, USA.
   */
  '109': 'BellSouth ICD AESA (ATM End System Address)',
  /**
   ...
   */
  '121': 'Affable Software Data Interchange Codes',
  /**
   ...
   */
  '123': 'BASF Company ATM-Network',
  /**
   * @description Issuing agency: DISC, British Standards Institution, UK.
   */
  '124': 'IOTA Identifiers for Organizations for Telecommunications Addressing using the ICD system format defined in ISO/IEC 8348',
  /**
   * @description Issuing agency: Henkel KgaA, Germany.
   */
  '125': 'Henkel Corporate Network (H-Net)',
  /**
   ...
   */
  '127': 'Dresdner Bank Corporate Network',
  /**
   * @description Issuing agency: Telekurs AG, Switzerland.
   */
  '128': 'BCNR (Swiss Clearing Bank Number)',
  /**
   * @description Issuing agency: Telekurs AG, Switzerland.
   */
  '129': 'BPI (Swiss Business Partner Identification) code',
  /**
   ...
   */
  '131': 'Code for the Identification of National Organizations',
  /**
   * @description Issuing agency: Certicom Corp, U.S.A.
   */
  '132': 'Certicom Object Identifiers',
  /**
   ...
   */
  '134': 'Infonet Services Corporation',
  /**
   ...
   */
  '136': 'Cable & Wireless Global ATM End-System Address Plan',
  /**
   ...
   */
  '138': 'France Telecom ATM End System Address Plan',
  /**
   ...
   */
  '139': 'Savvis Communications AESA:.',
  /**
   ...
   */
  '140': "Toshiba Organizations, Partners, And Suppliers' (TOPAS) Code",
  /**
   ...
   */
  '141': 'NATO Commercial and Government Entity system',
  /**
   ...
   * of Defense), USA.
   */
  '144': 'DoDAAC (Department of Defense Activity Address Code)',
  /**
   ...
   */
  '145': 'DGCP (Direction Générale de la Comptabilité Publique)administrative accounting identification scheme',
  /**
   * @description French taxation authority. Issuing agency: DGI (Direction Générale des Impots), France.
   */
  '146': 'DGI (Direction Générale des Impots) code',
  /**
   ...
   */
  '148': 'ITU (International Telecommunications Union)Data Network Identification Codes (DNIC)',
  /**
   ...
   */
  '149': 'Global Business Identifier',
  /**
   ...
   * Madge Networks, UK.
   */
  '150': 'Madge Networks Ltd- ICD ATM Addressing Scheme',
  /**
   ...
   */
  '152': 'Edira Scheme Identifier Code',
  /**
   ...
   */
  '153': 'Concert Global Network Services ICD AESA',
  /**
   ...
   */
  '155': 'Global Crossing AESA (ATM End System Address)',
  /**
   ...
   */
  '157': 'ATM interconnection with the Dutch KPN Telecom',
  /**
   ...
   */
  '159': 'ACTALIS Object Identifiers',
  /**
   ...
   */
  '160': 'GTIN - Global Trade Item Number',
  /**
   ...
   */
  '161': 'ECCMA Open Technical Directory',
  /**
   ...
   * Belgium.
   */
  '162': 'CEN/ISSS Object Identifier Scheme',
  /**
   ...
   */
  '163': 'US-EPA Facility Identifier',
  /**
   ...
   */
  '166': 'Swissguide Identifier Scheme',
  /**
   ...
   */
  '167': 'Priority Telecom ATM End System Address Plan',
  /**
   ...
   */
  '168': 'Vodafone Ireland OSI Addressing',
  /**
   ...
   */
  '169': 'Swiss Federal Business Identification Number. Central Business names Index (zefix) Identification Number',
  /**
   ...
   */
  '171': 'Luxembourg CP & CPS (Certification Policy and Certification Practice Statement) Index',
  /**
   ...
   */
  '172': 'Project Group “Lists of Properties” (PROLIST®)',
  /**
   ...
   */
  '179': 'Penango Object Identifiers',
  /**
   ...
   */
  '186': 'TrustPoint Object Identifiers',
  /**
   ...
   */
  '187': 'Amazon Unique Identification Scheme',
  /**
   ...
   */
  '189': 'European Business Identifier (EBID)',
  /**
   ...
   * Netherlands.
   */
  '190': 'Organisatie Indentificatie Nummer (OIN)',
  /**
   ...
   */
  '195': 'Singapore Nationwide E-lnvoice Framework',
  /**
   ...
   */
  '196': 'Icelandic identifier - Íslensk kennitala',
  /**
   ...
   */
  '206': 'Registre du Commerce et de l’Industrie : RCI',
  /**
   ...
   */
  '207': 'PiLog Ontology Codification Identifier (POCI)',
  /**
   ...
   */
  '214': 'Tradeplace TradePI Standard',
  /**
   * @description Intended Purpose/App. Area: Identification scheme will be used for electronic trade purposes in e-invoicing, purchasing, electronic receipts.
   ...
   */
  '219': 'Taxpayer registration code (Latvia)',
  /**
   ...
   * of Latvia.
   */
  '220': 'The Register of Natural Persons (Latvia)',
  /**
   ...
   */
  '221': 'The registered number of the qualified invoice issuer',
  /**
   ...
   */
  '228': 'Répertoire des Entreprises et des Etablissements (RIDET)',
  /**
   ...
   */
  '229': 'T.A.H.I.T.I (traitement automatique hiérarchisé des institutions de Tahiti et des îles)',
  /**
   ...
   */
  '230': 'National e-Invoicing Framework',
  /**
   ...
   * l’Informatique Financière de l’Etat)'
   */
  '231': 'Single taxable company (France)',
  /**
   * @description Intended Purpose/App. Area: . Issuing agency: '
   */
  '232': 'NOBB product number',
  /**
   ...
   * @description 'Intended Purpose/App. Area: . Issuing agency: '
   */
  '237': 'CPR (Danish person civil registration number)',
  /**
   ...
   * (Agence pour l’Informatique Financière de l’Etat)'
   */
  '238': 'Plateforme.s agréée.s à la facturation électronique (PPF/PDP)',
  ...
  '242': 'OpenPeppol Service Provider Identification Scheme (SPIS)',
...
export const icdCodesKeys = [
  ...
  78, 79, 80, 81, 82, 83, 84, 85, 86, 87, 88, 89, 90, 91, 93, 94, 95, 96, 97, 98, 99, 100, 101, 102, 104, 105, 106, 107, 108, 109, 110, 111, 112, 113,
  114, 115, 116, 117, 118, 119, 120, 121, 122, 123, 124, 125, 126, 127, 128, 129, 130, 131, 132, 133, 134, 135, 136, 137, 138, 139, 140, 141, 142,
  143, 144, 145, 146, 147, 148, 149, 150, 151, 152, 153, 154, 155, 156, 157, 158, 159, 160, 161, 162, 163, 164, 165, 166, 167, 168, 169, 170, 171,
  172, 173, 174, 175, 176, 177, 178, 179, 180, 183, 184, 185, 186, 187, 188, 189, 190, 191, 192, 193, 194, 195, 196, 197, 198, 199, 200, 201, 202,
