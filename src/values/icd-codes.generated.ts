...
/**
* Notes on Use of Code: The third digit in the organisation number is never lower than 2 in order to avoid it being confused with personal numbers. Issuing agency: The National Tax Board, SWEDEN.
*/
...
/**
* Issuing agency: General Computing Centre of the State, Committee of the USSR on Statistics, U S S R.
*/
...
/**
* Notes on Use of Code: The ICD code forms the initial part of the OSI network addressing as depicted in ISO 8348/AD2. Issuing agency: Norsk Hydro a.s., Norway.
*/
"0043": "HydroNETT",
/**
...
/**
* Issuing agency: Vereniging van Kamers van Koophandel en Fabrieken in Nederland Watermolenlaan, The Netherlands.
*/
...
/**
* de assigned by the French public accounting office. Issuing agency: DGCP (Direction Générale de la Comptabilité Publique), 139 Rue de Bercy, 75572 Paris Cedex 12, France
*/
...
/**
* Intended Purpose/App. Area: For use in electronic messages in accordance to the Singapore nationwide e-invoice framework on Identification of organization. Issuing agency: Infocomm Media Development Authority in Singapore.
*/
...
/**
* Intended Purpose/App. Area: The registered number of the qualified invoice issuer is used on the invoice-based method for Japanese consumption tax, which will be implemented on 1 October 2023. Issuing agency: National Tax Agency Japan
*/
"0221": "The registered number of the qualified invoice issuer",
/**
* Intended Purpose/App. Area: Database of metadata supporting description of object-data-information-etc. Issuing agency: Farance Inc.
*/
"0222": "Metadata Registry Support",
/**
* Intended Purpose/App. Area: To provide identifiers for organizations based in EU. Issuing agency: AIFE (Agence pour l’Informatique Financière de l’Etat)
*/
"0223": "EU based company",
/**
* Intended Purpose/App. Area: To provide identifiers used in electronic invoices for routing among accredited platforms for the French Continuous Transactional Control reform on e-invoicing. Issuing agency: AIFE (Agence pour l’Informatique Financière de l’Etat)
*/
"0224": "FTCTC CODE ROUTAGE",
/**
* Intended Purpose/App. Area: To provide identifiers used as electronic addresses in the context of the French Continuous Transactional Control reform on e-invoicing. Issuing agency: AIFE (Agence pour l’Informatique Financière de l’Etat)
*/
"0225": "FRCTC ELECTRONIC ADDRESS",
/**
* Intended Purpose/App. Area: To provide identifiers for French citizen sending invoices to the French Public Sector. Issuing agency: AIFE (Agence pour l’Informatique Financière de l’Etat)
*/
"0226": "FRCTC Particulier",
/**
* Intended Purpose/App. Area: NON - EU based company. Issuing agency: AIFE (Agence pour l’Informatique Financière de l’Etat)
*/
"0227": "NON - EU based company",
/**
* Intended Purpose/App. Area: To provide identifiers for organizations at national level in Nouvelle Caledonie (French). Issuing agency: AIFE (Agence pour l’Informatique Financière de l’Etat)
*/
"0228": "Répertoire des Entreprises et des Etablissements (RIDET)",
/**
* Intended Purpose/App. Area: To provide identifiers for organizations at national level in TAHITI (French). Issuing agency: AIFE (Agence pour l’Informatique Financière de l’Etat)
*/
"0229": "T.A.H.I.T.I (traitement automatique hiérarchisé des institutions de Tahiti et des îles)",
/**
* Intended Purpose/App. Area: Identifier for  organizations. Issuing agency: Malaysia Digital Economy Corporation Sdn Bhd (MDEC)
*/
"0230": "National e-Invoicing Framework",
/**
* 'Intended Purpose/App. Area: Provide identifiers to companies in a single taxable company regime. Issuing agency: AIFE (Agence pour l’Informatique Financière de l’Etat)'
*/
"0231": "Single taxable company (France)",
/**
* Intended Purpose/App. Area: . Issuing agency: '
*/
...
"0233": "Elnummer",
/**
* 'Intended Purpose/App. Area: Identification scheme is used to identify delivery locations of the Finnish government accounting units. Issuing agency: Toimitusosoite ID'
*/
"0234": "Toimitusosoite ID",
/**
* 'Intended Purpose/App. Area: A unique number issued to a range of persons required to be identified for tax purposes. Issuing agency: UAE Federal Tax Authority'
*/
...
/**
* 'Intended Purpose/App. Area: To provide identifiers for E-invoicing Public Platform and Partner Dematerialisation Platform. Issuing agency: AIFE (Agence pour l’Informatique Financière de l’Etat)'
*/
