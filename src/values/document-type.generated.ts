...
export const documentTypesTable: Record<DocumentTypesTableKeys, Array<string>> = {
  'busdox-docid-qns': [
...
export const documentTypesProcessIds: Record<string, Array<{ scheme: string; value: string }>> = {
