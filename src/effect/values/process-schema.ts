 ...
 * @see {@link processes}
 */
export type PeppolProcesses = typeof processSchema.Encoded;
 ...
 * @see {@link processes}
 */
export const processSchema = Schema.TemplateLiteral([Schema.Literals(processesKeys), Schema.Literal('::'), Schema.String]).check(
