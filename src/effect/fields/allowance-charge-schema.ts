...
import { baseLineAllowanceChargeSchema } from './line-allowance-charge-schema';
 ...
 */
export const allowanceChargeSchema = Schema.Union([
...
export type PeppolAllowanceCharge = typeof allowanceChargeSchema.Type;
