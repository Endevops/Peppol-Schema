 ...
 */
export const peppolLegalMonetaryTotalSchema = Schema.Struct({
  /**
   ...
   */
  allowanceTotalAmount: Schema.optional(peppolAmountSchema),
  /**
   ...
   */
  chargeTotalAmount: Schema.optional(peppolAmountSchema),
  /**
   ...
   */
  payableAmount: peppolAmountSchema,
  /**
   ...
   */
  payableRoundingAmount: Schema.optional(peppolAmountSchema),
  /**
   ...
   */
  prepaidAmount: Schema.optional(peppolAmountSchema),
  /**
   ...
   */
  taxExclusiveAmount: peppolAmountSchema,
  /**
   ...
   */
  taxInclusiveAmount: peppolAmountSchema,
});

export type PeppolLegalMonetaryTotal = typeof peppolLegalMonetaryTotalSchema.Type;
