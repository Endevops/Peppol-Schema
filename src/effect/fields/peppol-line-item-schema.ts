 ...
 * @name cac:Item
 */
export const peppolLineItemSchema = Schema.Struct({
  /**
  ...
  commodityClassifications: Schema.optional(
    Schema.Array(
      Schema.Struct({
         ...
         */
        itemClassification: peppolItemClassificationSchema,
      })
    )
  ),
  /**
   ...
   */
  classifiedTaxCategory: peppolTaxCategorySchema,
  /**
...
export type PeppolItem = typeof peppolLineItemSchema.Type;
