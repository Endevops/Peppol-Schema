...
import { additionalDocumentReferenceCodeSchema } from '#/effect/values/additional-document-reference-code';

import { binaryObjectSchema } from './binary-object-schema';
 ...
 */
export const additionalDocumentReferenceSchema = identifierSchema().pipe(
  Schema.fieldsAssign({
    /**
...
export type PeppolAdditionalDocumentReference = typeof additionalDocumentReferenceSchema.Type;
