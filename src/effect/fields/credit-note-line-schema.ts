 ...
 */
export const creditNoteLineSchema = baseLineSchema.pipe(
  Schema.fieldsAssign({
    /**
     ...
     */
    creditedQuantity: quantitySchema.pipe(
      Schema.fieldsAssign({
        /**
...
export type PeppolCreditNoteLine = typeof creditNoteLineSchema.Type;
