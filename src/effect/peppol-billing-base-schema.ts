...
import { PeppolAdditionalDocumentReference } from '#/effect/fields/peppol-additional-document-reference-schema';
import { peppolAllowanceChargeSchema } from '#/effect/fields/peppol-allowance-charge-schema';
import { PeppolBillingReference } from '#/effect/fields/peppol-billing-reference-schema';
import { PeppolDelivery } from '#/effect/fields/peppol-delivery-schema';
import { PeppolInvoicePeriod } from '#/effect/fields/peppol-invoice-period-schema';
import { PeppolLegalMonetaryTotal } from '#/effect/fields/peppol-legal-monetary-total-schema';
import { PeppolOrderReference } from '#/effect/fields/peppol-order-reference-schema';
import { PeppolPartyBase } from '#/effect/fields/peppol-party-base-schema';
import { PeppolPayeeParty } from '#/effect/fields/peppol-payee-party-schema';
import { PeppolPaymentMeans } from '#/effect/fields/peppol-payment-means-schema';
