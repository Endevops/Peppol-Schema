...
import { documentResponseLineResponseContent } from './document-response-line-response-content';

export const documentResponseLineResponseSchema = Schema.Struct({
  /**
...
export type PeppolMessageLevelDocumentResponseLineResponse = typeof documentResponseLineResponseSchema.Type;
